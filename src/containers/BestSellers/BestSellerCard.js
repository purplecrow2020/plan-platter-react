    ...
    return (
        ...
        <div className="container mt-4" >
            <div style={{ position: 'relative' }}>
                <img src={props.item_img} className="img-fluid" alt="food-small-card-img" style={{ borderRadius: '5px', maxWidth: '100PX', maxHeight: '100px' }} />
                <div className="d-flex align-items-start" style={{ position: 'absolute', top: '0px', right: '35px' }}>
                    <a href="#ad-link" className="add-btn-3">
                        <span> {props.item_rating} <span style={{position: 'relative', top:'-5px'}} >&#10032;</span> </span>
                    </a>
                </div>
