                        ...
                        return (
                            <><div className="row">
                                ...
                                <div className="row mt-3">
                                    <div className="col-1 " style={{ marginTop: 'px' }}>
                                    ...
                                    <div className="col-4" style={{ padding: '0px !important', maxWidth: '250px' }}>
                                    ...
                                    <div className="col-2 pl-2 pl-sm-0 text-end">₹{item.price * item.qty}</div>
                                </div></>
                        ...
                        <>
                            ...
                            <div className="row">
                                <div className="col">
                                    ...
                                    <div className="row cd-text-2">
                                        <div className="col-9">Service Tip</div>
                                        <div className="col-3">
