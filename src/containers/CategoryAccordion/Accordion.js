                      ...
                      <ul className="body-ul">
                        {
                            this.props.menu[item_category].map((item, index) => {
                                return (
                                    <li className="mt-4 "> <a href="#manage-address" className="text-decoration-none ct-heading"><MenuItemCard item_name={item.name} item_img_url={item.img_url} item_price={item.price} dietary_flag={item.dietary_flag} /></a> </li>
                                )
                            })
                        }
                      </ul>
